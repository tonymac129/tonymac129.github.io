...
const skills = [
  ...
  { id: 6, name: "Python", percent: 40, description: "Python is a powerful and versatile language.", type: ["language"] },
  { id: 7, name: "Java", percent: 40, description: "Popular language that's used almost everywhere.", type: ["language"] },
  { id: 8, name: "Unity", percent: 40, description: "The most used game engine to make games.", type: ["tool"] },
  { id: 9, name: "C#", percent: 15, description: "A versatile programming language used by Unity.", type: ["language"] },
  { id: 10, name: "Web Design", percent: 70, description: "Designing a website to make it more appealing.", type: ["web"] },
  { id: 11, name: "CLI", percent: 50, description: "Using tools like Git, npm, and Vite through a terminal.", type: ["tool"] },
  { id: 12, name: "Typing", percent: 98, description: "Speed typing means typing really fast.", type: ["other"] },
  { id: 13, name: "Chinese", percent: 95, description: "The language with the most native speakers.", type: ["other"] },
  { id: 14, name: "Diabolo", percent: 85, description: "This toy is spun, thrown, or juggled with a string.", type: ["other"] },
  { id: 15, name: "Basketball", percent: 80, description: "A sport where you shoot baskets to score.", type: ["other"] },
  { id: 16, name: "Cubing", percent: 70, description: "Sorting the colors on a Rubik's cube.", type: ["other"] },
];
