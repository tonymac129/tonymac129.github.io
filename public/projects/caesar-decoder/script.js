...
form.addEventListener("submit", (e) => {
  ...
  outputBox.innerHTML = outputs[outputIndex];
  back.addEventListener("click", () => {
    outputIndex = outputIndex == 0 ? 25 : outputIndex - 1;
    outputBox.innerHTML = outputs[outputIndex];
  });
  next.addEventListener("click", () => {
    outputIndex = outputIndex == 25 ? 0 : outputIndex + 1;
    outputBox.innerHTML = outputs[outputIndex];
  });
});
